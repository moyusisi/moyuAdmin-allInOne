...
public class ${entityName}Controller {
     ...
     * ${entityDesc}列表
     */
    //@SaCheckPermission("${moduleName}:${entityName?uncap_first}:list")
    @PostMapping("/list")
     ...
     * ${entityDesc}分页列表
     */
    //@SaCheckPermission("${moduleName}:${entityName?uncap_first}:page")
    @PostMapping("/page")
     ...
     * ${entityDesc}详情
     */
    //@SaCheckPermission("${moduleName}:${entityName?uncap_first}:detail")
    @PostMapping("/detail")
     ...
     * 新增${entityDesc}
     */
    //@SaCheckPermission("${moduleName}:${entityName?uncap_first}:add")
    @PostMapping("/add")
     ...
     * 修改${entityDesc}
     */
    //@SaCheckPermission("${moduleName}:${entityName?uncap_first}:edit")
    @PostMapping("/edit")
     ...
     * 删除数据
     */
    //@SaCheckPermission("${moduleName}:${entityName?uncap_first}:delete")
    @PostMapping("/delete")
