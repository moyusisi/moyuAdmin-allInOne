...
//    @PreAuthorize("hasRole('ROOT') || hasAuthority('sys:group:detail')")
    @SysLog(module = "system", value = "查询岗位详情")
    @PostMapping("/detail")
    ...
    @SysLog(module = "system", value = "新增岗位")
    @PostMapping("/add")
    ...
    @SysLog(module = "system", value = "删除岗位")
    @PostMapping("/delete")
    ...
    @SysLog(module = "system", value = "修改岗位")
    @PostMapping("/edit")
...
//    @PreAuthorize("hasRole('ROOT') || hasAuthority('sys:group:roleList')")
    ...
    @PostMapping("/addRole")
    @SysLog(module = "system", value = "岗位内添加角色")
    ...
    @SysLog(module = "system", value = "岗位内移除角色")
...
//    @PreAuthorize("hasRole('ROOT') || hasAuthority('sys:group:userList')")
    ...
    @SysLog(module = "system", value = "岗位内的添加用户")
    @PostMapping("/addUser")
    ...
    @SysLog(module = "system", value = "岗位内的移除用户")
